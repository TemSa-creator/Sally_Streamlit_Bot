...
if len(st.session_state.messages) == 1:
    selly_intro = (
        ...
        f"Ich bin Selly – und heute ganz persönlich **im Auftrag von {st.session_state.tentary_id if st.session_state.authenticated else 'meiner Auftraggeberin'}** für dich da. 😍\n\n"
